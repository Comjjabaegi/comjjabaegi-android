package com.example.studyapp.ui.papago;
...
public class PapagoFragment extends AppCompatActivity {

    Button btTranslate, btErase;
    EditText etSource;
    TextView tvResult;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btErase = (Button) findViewById(R.id.button);
